    ...
    <>
      <style suppressHydrationWarning>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mob-foot-lang button:hover { background: rgba(255,255,255,.15); color: #fff; }
          ...
          <nav className="mob-nav" onClick={e => e.stopPropagation()}>
            ...
            <div className="mob-foot">
              ...
              <div className="mob-foot-actions">
                ...
                <a href="/login?mode=signup&role=patient" className="mob-foot-cta" onClick={() => setMenuOpen(false)}>{t('nav_create')} →</a>
              </div>
            </div>
          </nav>
        </div>
