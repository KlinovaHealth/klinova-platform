...
const T = {
  en: {
    ...
    h1:'One doctor.', h1_accent:'Every remote village.',
    ...
    sl4:'First real-world pilots planned · Togo · Ghana · by Summer 2027',
    rural_ey:'The rural village model', rural_h:'Healthcare coverage where there are no roads to build clinics.',
    rural_sub:"Klinova does not replace the healthcare system; it extends it. We connect licensed doctors to patients spread across remote villages via WhatsApp, SMS, or the Klinova app.",
  ...
  fr: {
    ...
    h1:'Un médecin.', h1_accent:'Chaque village reculé.',
    ...
    sl4:'Premiers pilotes prévus · Togo · Ghana · d\'ici l\'été 2027',
    rural_ey:'Le modèle village rural', rural_h:'Couverture sanitaire là où il n\'y a pas de routes pour construire des cliniques.',
    rural_sub:"Klinova ne remplace pas le système de santé, il l'étend. Nous connectons des médecins agréés aux patients dispersés dans les villages éloignés via WhatsApp, SMS ou l'application Klinova.",
